...
// Ye function ab text toggle ke baad AOS layout ko refresh karega taaki overlap na ho
window.toggleRules = function(id, btnElement) {
    ...
    if(ruleBox) {
        ...
        // Very Important: Force browser layout refresh
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Mobile par 3D tilt band kiya hai kyunki touch screen par height freeze ho jaati hai
...
// 5. CONFETTI ANIMATION (Delayed so website loads fast)
